...
class MajorityVoteClassifier(BaseEstimator, ClassifierMixin):
    ...
    weights : array-like, shape = [n_classifiers]
        ...
        If a list of 'int' of 'float' values are provided,
    ...
    def fit(self, X, y):
        ...
        self : object
        """
        # use LabelEncode to ensure class labels start
    ...
    def predict_proba(self, X):
        ...
        X : { array-like, sparse matrix},
            shape = [n_samples, n_features]
            Training vectors, where n_samples is the number or samples and n_features is the number of features.
